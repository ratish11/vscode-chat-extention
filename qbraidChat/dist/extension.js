...
var ChatViewProvider = class {
  ...
  async sendMessage(message) {
    ...
    try {
      ...
      this._updateWebview();
      const response = await axios_default.post("YOUR_API_ENDPOINT", {
        message
      }, {
        headers: {
...
var CONFIG_DIR = path.join(os2.homedir(), ".qbraid");
...
function activate(context) {
  ...
  const sendMessageCommand = vscode2.commands.registerCommand(
    ...
    async () => {
      ...
      try {
        await vscode2.commands.executeCommand("chatView.focus");
        ...
        vscode2.window.showErrorMessage("Failed to initialize chat view");
      }
    }
  );
